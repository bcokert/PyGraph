...
class TestSimpleTurtle(unittest.TestCase):
    ...
    def test_interface(self):
        for func in ('turnRight', 'turnLeft', 'push', 'pop', 'reset', 'draw'):
    ...
    def test_turnRight(self):
        self.assertEqual(self.turtle.turnRight(30), 60)
        self.assertEqual(self.turtle.turnRight(90), 330)

    def test_turnLeft(self):
        self.assertEqual(self.turtle.turnLeft(30), 120)
        self.assertEqual(self.turtle.turnLeft(300), 60)
